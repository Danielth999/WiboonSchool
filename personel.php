...
// Get Structure
$stmt = $conn->prepare("SELECT * FROM school_structure WHERE type = :type AND status = 1  ORDER BY id ASC LIMIT 1");
...
<head>
    ...
    <title>โครงสร้าง<?= $st && isset($st['name']) ? $st['name'] : '' ?> - โรงเรียนวิบูลวิทยา</title>
    <!-- SEO Meta Tags -->
                    ...
                    <ol class="flex items-center space-x-2 text-gray-600">
                        ...
                        <li class="flex items-center">
                            <a href="#" class="hover:underline">
                                <i class="fas fa-users mr-1"></i> บุคลากร
                            </a>
                            <span class="mx-2 text-gray-400">/</span>
                        </li>
                        <li class="flex items-center">
                            <span class="text-gray-800 font-semibold">
                                ...
                                โครงสร้าง<?= $st && isset($st['name']) ? $st['name'] : '' ?>
                            </span>
                        </li>
                    </ol>
                </nav>
